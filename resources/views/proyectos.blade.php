...
<head>
    ...
    <style>
        ...
        /* Agrega estilos para el contenido interno de la tarjeta si es necesario */
        .card-content {
            padding: 20px;
        ...
        <div class="header-container">
            ...
            <div class="cerrar-section">
                <div class="navbar-section">
                    <a class="nav-link" href="/">Gestion de Proyectos</a>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(".cargarModal").click(function() {
                ...
                // Verificar que el array tiene al menos 6 elementos antes de acceder a ellos
